...
bot.dialog('/completiondiploma', [
    ...
    function (session) {
        ...
        session.send("First let's retrieve your ‘Completion Diploma’ once you have passed the eLearning:/n• Go back in EYLeads to the Activity Details page for EYDelivers for Engagement Administrators/n• Scroll down in the lesson descriptionNovember 2016EYD V3.0EYDelivers: Request an EYD site QRG/n• Click on the diploma icon/n• Make a print screen of the diploma");
