...
var QnAMakerDialog = (function (_super) {
    ...
    function QnAMakerDialog(options) {
       ...
       //     var i = 0;
        //    if (i > 0) {
           //     this.defaultNoMatchMessage = "No match found!  Please re-enter your search or type 'menu' to return to the main menu.";
        //    } else {
       //         this.defaultNoMatchMessage = "Ask me any question";
              // this.defaultNoMatchMessage = "No match found!  Please re-enter your search or type 'menu' to return to the main menu.";
       //         i++
       //     }
       ...
       //     this.defaultNoMatchMessage = this.options.defaultMessage;
        //    this.defaultNoMatchMessage = "No match found!  Please re-enter your search or type 'menu' to return to the main menu.";
        //    this.defaultNoMatchMessage = "Sorry dude!  No match found!"
      //  }
      //  else {
      //      this.defaultNoMatchMessage = "No match found!  Please re-enter your search or type 'menu' to return to the main menu.";
        //    this.defaultNoMatchMessage = "Ask me any question";
     ...
     if (this.options.defaultMessage && this.options.defaultMessage !== "") {
            this.defaultNoMatchMessage = this.options.defaultMessage;
       //     console.log("first defaultMessage" + this.options.defaultMessage + "first defaultNoMatchMessage" +  this.defaultNoMatchMessage);
        }
        else {
    ...
    QnAMakerDialog.prototype.invokeAnswer = function (session, recognizeResult, threshold, noMatchMessage) {
        ...
        //    session.send("Great, can I help you with anything else?");
           
            session.beginDialog('/faqhelp');
        }
        else {
           // if (qnaMakerResult.score == "0" && qnaMakerResult.score < threshold) {
           //     session.send(noMatchMessage);
           // } else {
           //     session.send("No match found!  Please re-enter your search or type 'menu' to return to the main menu.");
            
           // }
         //  console.log("first defaultMessage" + this.options.defaultMessage + "first defaultNoMatchMessage" +  this.defaultNoMatchMessage);
           if (qnaMakerResult.score == "0") {
            session.send(noMatchMessage);
           } else if (qnaMakerResult.score != "0") { 
                console.log("The score is = " + qnaMakerResult.score);
                console.log("The threshold is = " + threshold);
            //    console.log("The utterance = " + QnAMakerRecognizer.postBody);

             //   console.log("The Answer is = " + result.answer);
             //   console.log("The Result Score = " + result.score);
                
                //qnaMakerResult.score == 0.48123878315091095
                if (qnaMakerResult.score == 0.1) {
              //  if (qnaMakerResult.score == 0) {
                  session.send("No match found!  Please re-enter your question or type 'menu' to return to the main menu.");
                    //session.send(noMatchMessage);
                } else {
